...
def find_centroid(cluster):
    ...
    long = [restaurant_location(restaurant)[1] for restaurant in cluster]
...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    "*** YOUR CODE HERE ***"
    predict_list = [find_predictor(user, reviewed, func) for func in feature_fns]
    d = {predictor: r_squared for predictor, r_squared in predict_list}
