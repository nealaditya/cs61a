...
# END Problem 13
    ...
    def __init__(self, armor = 1):
        ...
        self.ant_lst = []
        self.is_queen = QueenAnt.one_queen 
    ...
    def action(self, colony):
        ...
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        def doubling(self, ant): 
            if ant not in self.ant_lst: 
                ant.damage *= 2 
                self.ant_lst.append(ant)
        ...
        if not self.is_queen: 
            ...
            while place: 
                if place.ant: 
                    doubling(self, place.ant)
                if place.ant and place.ant.container and place.ant.ant: 
                    doubling(self, place.ant.ant)
                place = place.exit
